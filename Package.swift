  ...
  targets: [
    .target(
      ...
      exclude: ["Gallery115.xcodeproj", "115褰卞粖_iPhone_v1.0", "cineva-auth-server", ".github",
                ...
                "Gallery115/Resources", "Gallery115/Info.plist",
                ...
                "Gallery115/Services/KeychainStore.swift",
      ...
      sources: ["Gallery115/Services/ArtworkDiskStore.swift", "Gallery115/Services/ThumbnailService.swift",
                ...
                "Gallery115/Models/PlaybackEntry.swift", "Gallery115/Services/LibraryStore.swift",
